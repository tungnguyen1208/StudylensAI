...
|---|---|---|---|---|---|---|
| **Dev 1** | **Video Activation & Content Acquisition** | `apps/extension/src/features/video-activation/**`<br>`apps/extension/src/platform/youtube/**` | `services/api/src/StudyLens.Api/Features/VideoActivation/**` | `services/ai/app/features/classification/**` | `contracts/public-api/video-activation.yaml`<br>`contracts/ai-api/classification.yaml`<br>`contracts/extension-messages/video-activation.schema.json`<br>`contracts/examples/video-activation/**` | `services/api/tests/VideoActivation.Tests/**`<br>`tests/contract/video-activation/**`<br>`tests/e2e/video-activation/**` |
