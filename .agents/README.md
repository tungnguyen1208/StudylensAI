...
4. Use a repo skill when the task matches one of the workflows.
5. Use a custom agent profile only when the user asks for a specific dev role or parallel agent work.
