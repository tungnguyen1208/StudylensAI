...
const activation = { activationId: '11111111-1111-4111-8111-111111111111', source: 'user' as const, videoTitle: 'Video', transcriptCapture: { transcriptCaptureId: '22222222-2222-4222-8222-222222222222', youtubeVideoId: 'dQw4w9WgXcQ', language: 'en', source: 'tabAudioStt' as const, status: 'available' as const, availableCueCount: 1, version: 1 }, preferences: { quizIntervalMinutes: 10 as const, questionType: 'multipleChoice' as const, difficulty: 'medium' as const } };
