...
const activation = {
  ...
  videoTitle: 'Video',
  transcriptSnapshot: { transcriptSnapshotId: '33333333-3333-4333-8333-333333333333', youtubeVideoId: VIDEO_ID, language: 'en', status: 'available' as const, contentHash: 'a'.repeat(64), version: '0.2.0' },
